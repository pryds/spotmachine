...
echo "#!/bin/bash" > spotmachine
echo "java -classpath \$CLASSPATH:../bin:resources/gettext-commons-0.9.6.jar main.SpotMachine \$1" >> spotmachine
chmod +x spotmachine
echo "Start script written. Run ./spotmachine to start without installing."
